...
model_path = hf_hub_download(repo_id="fzisengwe/Tourism-Package-Prediction", filename="tourism_model.pkl")   # Replace <-------Hugging Face user ID --------->/<---model_repository_name--->", filename="<---model_filename---> with your Hugging Face username, model repository name, and model filename.
...
NumberOfChildrenVisiting= st.slider("NumberOfChildrenVisiting", 0, 5, 1)
